"""
CLASIFICADOR FLORES TIPO IRIS CON IRIS DATASET A PARTIR DEL PETALO
"""
...
# Adicionalmente eliminamos las columnas de sepalo para predecir los valores solo a partir de los petalos
